    ...
    if (typeof rate === "number") {
      ...
      for (var i = 0; i < id.length; i++) {
        ...
        if (sound) {
          ...
          var duration =
            (self._sprite[sound._sprite][0] + self._sprite[sound._sprite][1]) /
              1000 -
            seek;
          var timeout = (duration * 1000) / Math.abs(sound._rate);
...
Howl.prototype.stereo = function (pan, id) {
  ...
  var pannerType =
    typeof Howler.ctx.createStereoPanner === "undefined" ? "spatial" : "stereo";
      ...
      pa = {
        ...
        distanceModel:
          typeof o.distanceModel !== "undefined"
            ...
            : pa.distanceModel,
        maxDistance:
          typeof o.maxDistance !== "undefined" ? o.maxDistance : pa.maxDistance,
        refDistance:
          typeof o.refDistance !== "undefined" ? o.refDistance : pa.refDistance,
        rolloffFactor:
